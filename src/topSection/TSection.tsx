...
class TSection extends React.PureComponent {
  ...
  button_click() {
    const input_val = document.getElementsByTagName('input')[0].value.trim();
    localStorage.setItem('input_value', input_val);

    const all_people_info:ElementType[] = JSON.parse(localStorage.getItem('allPeople')||"");
